...
import { View, Text, Image, TouchableOpacity,Modal, SafeAreaView, TextInput, StyleSheet, Picker} from "react-native";
...
export function ActionModalEdit({ handleClose }) {
    return (
      <SafeAreaView style={styles.container}>
          ...
          <TextInput placeholder='Edite sua ocorrência'  style={styles.input}></TextInput>
